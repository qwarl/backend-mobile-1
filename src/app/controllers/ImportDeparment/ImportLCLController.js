const ImportLCL = require("../../models/ImportDeparment/ImportLCL");

class ImportLCLController {
  //[GET] /ImportLCLs/getAll
  async getAll(req, res) {
    try {
      const importLCL = await ImportLCL.find({});
      res
        .status(200)
        .json({
          success: true,
...
module.exports = new ImportLCLController();
